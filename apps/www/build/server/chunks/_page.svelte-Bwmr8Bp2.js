...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "ea91d87a-8d00-41fe-8604-8dfdd7188936", e._sentryDebugIdIdentifier = "sentry-dbid-ea91d87a-8d00-41fe-8604-8dfdd7188936");
  } catch (e2) {
  }
}();
function _page($$payload) {
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Data Stream API</title>`;
  });
  $$payload.out += `<!--[-->`;
...
//# sourceMappingURL=_page.svelte-Bwmr8Bp2.js.map
