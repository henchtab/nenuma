import { n as notifyManager, S as Subscribable, l as resolveEnabled, q as shallowEqualObjects, r as resolveStaleTime, b as noop, t as isServer, u as isValidTimeout, v as timeUntilStale, f as focusManager, w as fetchState, x as replaceData, y as getIsRestoringContext, z as getQueryClientContext } from './context-DhSgOhFj.js';
import { r as readable, d as derived, g as get } from './index2-d8GdKNTl.js';
...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "05acfc8d-8106-4bf2-9c36-1e6134680914", e._sentryDebugIdIdentifier = "sentry-dbid-05acfc8d-8106-4bf2-9c36-1e6134680914");
  } catch (e2) {
  }
}();
...
function formatAddressString(addressString, prefixLength, suffixLength) {
...
function shortenAddress(address, prefixLength = 6, suffixLength = 6) {
  const addressString = getAddressString(address);
  return formatAddressString(addressString, prefixLength, suffixLength);
}

export { generateId as a, createQuery as c, generateIds as g, last as l, next as n, prev as p, shortenAddress as s };
//# sourceMappingURL=shorten-address-Dkp__QzI.js.map
