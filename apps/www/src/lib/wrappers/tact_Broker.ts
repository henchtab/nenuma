...
async function Broker_init(brokerage: Address, stream: Address) {
    const __code = Cell.fromBase64('');
    ...
    initBroker_init_args({ $$type: 'Broker_init_args', brokerage, stream })(builder);
...
export class Broker implements Contract {
    ...
    static async init(brokerage: Address, stream: Address) {
        return await Broker_init(brokerage, stream);
    }
    
    static async fromInit(brokerage: Address, stream: Address) {
        const init = await Broker_init(brokerage, stream);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: BRKDeploy | BRKDeposit | BRKWithdraw) {
