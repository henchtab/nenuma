<script lang="ts">
  import { Broker, Brokerage, BrokerageAccount, CashOrNothingOption } from './components';
</script>
...
<div>
  <div class="py-6 border-b">
    <h1 class="text-ds-gray-1000 container font-semibold text-3xl text-left">Options API</h1>
  </div>
